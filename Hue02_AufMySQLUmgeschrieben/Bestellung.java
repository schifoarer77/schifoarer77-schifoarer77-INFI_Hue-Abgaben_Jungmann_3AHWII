...
public class Bestellung {
	...
	public static void selectBestellung(Connection c, int Kunden) {
        try {
            Statement stmt = c.createStatement();
            String sql = "SELECT k.name, a.bezeichnung, b.anzahl, (SELECT a.preis * b.anzahl " +
...
//Aufgabe a) Erweiterung
	public static void deleteBestellung(Connection c, int kundenID, int artikelID, String bestelldatum) {
		try {
			Statement stmt = c.createStatement();
...
//Aufgabe b) Erweiterung
	public static void updateBestellung(Connection c, int kundenID, int artikelID, int anzahl, String bestelldatum) {
		try {
			Statement stmt = c.createStatement();
			String sql = "update Bestellung set anzahl = "+ anzahl +" where kundenID = "+ kundenID +" and artikelID = "+ artikelID +" and bestelldatum = \""+ bestelldatum +"\";";
			stmt.executeUpdate(sql);
			stmt.close();
		} catch (SQLException e) {
			e.printStackTrace();
